...
import 'package:vivid/components/ui/widgets/chat_message.dart';
import 'package:vivid/components/ui/widgets/chat_message_other.dart';
  ...
  Widget build(BuildContext context) {
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        if (user != null && user.uid == data['senderId']) {
          return Dismissible(
            onDismissed: (_) {
