              ...
              children: <Widget>[
                ...
                Container(
                  ...
                  child: FlatButton(
                    ...
                    child: Text('Edit Nickname', style: TextStyle(
                      fontSize: 32, fontFamily: 'BloggerSans',
                ...
                Container(
                  margin: EdgeInsets.only(top: 5),
                  child: Text('About ViVid', style: TextStyle(
                    fontSize: 22, fontFamily: 'BloggerSans',
                    fontWeight: FontWeight.w800
                  ))),
                  Container(
                  ...
                  child: Column(
                    children: <Widget>[
                      ...
                      Text('DanRedTMF', style: TextStyle(
                        fontSize: 28, fontFamily: 'BloggerSans',
                        fontWeight: FontWeight.w800, color: Colors.white
                      )),
                    ],
                  )
